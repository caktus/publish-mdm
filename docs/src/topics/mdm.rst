...
.. note::
    ...
    :doc:`Getting Started with Device Management <../getting-started/device_management_quickstart>`
    for a step-by-step walkthrough of setting up an organization, enrolling a device,
    and automating ODK project deployment to your devices.
